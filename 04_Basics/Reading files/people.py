...
# If we call the function with the argument ("Paul Paulson", 37, 175.5), the function should write this line to the end of the file:
...
if __name__ == "__main__":
    t = ("Paul Paulson", 37, 175.5)
    print(store_personal_data(t))